...
Preprocess MRI images from NIFTI files into matrices and save as pt file.
The preprocessing constists of two parts:
First the nii files are converted into matrices and written into interim.
Second for some given threshold connections between brain parcellations that
